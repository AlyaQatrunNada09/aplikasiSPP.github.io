      ...
      <!-- Main Content -->
                ...
                <div class="card-header">
                  <h3 class="card-title">Histori Pembayaran</h3>
                      ...
                      <div class="card-body">
                      <h6 class="card-text" >Entri Pembayaran</h6>
                  <a class='btn btn-outline-primary' href="../Petugas/Entri-Pembayaran.php">Bayar</a>
                  ...
                  while($data = mysqli_fetch_array($sql)){
                    ...
                    echo"<td><a class='btn btn-outline-info' href='form_ubah.php?id_pembayaran=".$data['id_pembayaran']."'>Ubah</a>
