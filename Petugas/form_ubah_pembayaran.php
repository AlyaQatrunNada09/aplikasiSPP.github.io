              ...
              <div class="card card-statistic-2">
                <div class="card-stats">
                  <div class="card-stats-title text-center">
                    ...
                    pembayaran.tahun_dibayar,spp.id_spp, spp.nominal, pembayaran.jumlah_dibayar FROM pembayaran, petugas, spp, siswa WHERE pembayaran.nisn=siswa.nisn AND pembayaran.id_spp=spp.id_spp AND pembayaran.id_pembayaran = '".$id_pembayaran."'";
